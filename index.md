...
venue: "Interdisciplinary Science and Technology Building 10(ISTBX), Arizona State University"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
helper: ["Erica Bailin",  "Snehal Chaudhari",  "Ariel Harrington"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
